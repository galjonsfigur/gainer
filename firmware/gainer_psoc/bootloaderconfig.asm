...
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[0bh], bbh		; Port_2_DriveMode_2 register (PRT2DM2)
	mov	reg[0ah], 44h		; Port_2_GlobalSelect register (PRT2GS)
	M8C_SetBank1
...
;  Global Register values
	...
	db		b6h, 02h		; Row_0_OutputDrive_1 register (RDI0SRO1)
